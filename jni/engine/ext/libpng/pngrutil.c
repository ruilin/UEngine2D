	...
	png_bytep output, png_size_t output_size)
{
   ...
   while (1)
   {
	 ...
	 else
	 {
	    ...
	    {
	 case Z_BUF_ERROR:
	    msg = (char *)"Buffer error in compressed datastream in %s chunk";
	    break;
	 case Z_DATA_ERROR:
	    msg = (char *)"Data error in compressed datastream in %s chunk";
	    break;
	 default:
	    msg = (char *)"Incomplete compressed datastream in %s chunk";
	    break;
	    }
...
void /* PRIVATE */
png_handle_IEND(png_structp png_ptr, png_infop info_ptr __attribute__ ((unused)), png_uint_32 length)
{
...
defined(PNG_USER_TRANSFORM_PTR_SUPPORTED)
   ...
   png_debug1(3, "width = %lu,", png_ptr->screenWidth);
   png_debug1(3, "height = %lu,", png_ptr->screenHeight);
